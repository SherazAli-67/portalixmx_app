...
class ResidentAdminMainMenuPage extends StatelessWidget{
  const ResidentAdminMainMenuPage({super.key});
      ...
      return Scaffold(
        ...
        body: Stack(
          children: [
            ...
            SafeArea(child: _buildAdminMenuItem(provider.currentIndex)),
          ],
        ),
      );
    },
  ...
  Widget _buildAdminMenuItem(int currentIndex) {
    switch(currentIndex){
      case 0:
        return HomePage();
